...
use crate::type_data::{
   ExpressionType, F32_TYPE, F64_TYPE, I32_TYPE, IntType, U8_TYPE, U32_TYPE, U64_TYPE, USIZE_TYPE,
};
   ...
   match target {
      ...
      Target::QbeHost => Box::new([
         ...
         SpecialProcedure {
            ...
            required: true,
            input_types: vec![
               ExpressionType::Pointer(Box::new(U8_TYPE)),
               ExpressionType::Pointer(Box::new(U8_TYPE)),
               USIZE_TYPE,
            ],
            return_type: ExpressionType::Unit,
...
fn get_type(
   ...
   match expr {
      ...
      Expression::UnresolvedEnumLiteral(x, v) => {
         let mut base_t = ExpressionType::Unresolved {
            name: x.str,
         ...
         match base_t {
            ...
            other_t => {
               rolandc_error!(
                  err_manager,
                  x.location,
                  "Attempted to instatiate `{}` as an enum",
                  other_t.as_roland_type_info(
                     validation_context.interner,
                     validation_context.user_defined_types,
                     validation_context.procedures,
                     &validation_context.owned.type_variables
